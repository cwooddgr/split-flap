// Firebase app, anonymous auth, and the sign-in helper, shared by both pages.
// Firestore is not here: the display loads the full SDK (firebase-init.js) and
// the remote loads Firestore Lite (firebase-lite.js).
...
export { app, ensureSignedIn, backoffMs };
